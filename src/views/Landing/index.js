                ...
                <section className="pb-40 bg-blueGray-200 -mt-24">
                    <div className="container mx-auto px-4">
                            ...
                            <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                    <div className="px-4 py-5 flex-auto">
                                        ...
                                        <h6 className="text-xl font-semibold">Set up your wallet</h6>
                            ...
                            <div className="w-full md:w-4/12 px-4 text-center">
                                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                    <div className="px-4 py-5 flex-auto">
                                        ...
                                        <h6 className="text-xl font-semibold">Create your collection / NFTS</h6>
                                        <p className="mt-2 mb-4 text-blueGray-500">
                            ...
                            <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                    <div className="px-4 py-5 flex-auto">
                                        ...
                                        <h6 className="text-xl font-semibold">List them for sale</h6>
                                        <p className="mt-2 mb-4 text-blueGray-500">
                        ...
                        <div className="text-center mt-6">
                            <button className="bg-lightBlue-500 rounded-lg px-4 py-3 text-white font-bold text-lg">Go to Rankings</button>
                        </div>
